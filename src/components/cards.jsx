...
export default function Card({game}){
    ...
    return(
            <div className="flex flex-col items-center w-48  relative "  >
                {
                    favorito ? 
                    <FavoriteIcon onClick={desfavoritar} className=" text-red-600  cursor-pointer absolute top-2 right-2"/>:
                ...
                <span className="text-white text-lg font-bold line-clamp-1" >{game.name}</span>
                <div>
                    <i></i>
